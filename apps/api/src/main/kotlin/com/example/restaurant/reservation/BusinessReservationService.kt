    ...
    private fun ReservationEntity.toDetail(
        ...
        return BusinessReservationDetailResponse(
            ...
            customer = BusinessReservationCustomerDetailResponse(
                ...
                anniversaryType = customer.anniversaryType,
                anniversaryDate = customer.anniversaryDate,
                preferenceNote = customer.preferenceNote,
                vip = customer.vip,
                caution = customer.caution,
                cautionReason = customer.cautionReason,
                blocked = customer.blocked,
                blockedReason = customer.blockedReason,
                reservationCount = reservationRepository.countByCustomerId(customer.id),
                visitCount = reservationRepository.countByCustomerIdAndStatus(customer.id, ReservationStatus.COMPLETED),
