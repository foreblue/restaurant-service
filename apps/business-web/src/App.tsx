      ...
      <div className="grid min-h-screen grid-cols-1 lg:grid-cols-[252px_1fr]">
        <aside className="border-border bg-card/95 px-5 py-4 shadow-sm lg:border-r">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm font-semibold">예약 운영</p>
              <p className="text-xs text-muted-foreground">사업자 콘솔</p>
            </div>
          </div>

          <nav className="mt-7 grid gap-1 text-sm" aria-label="주요 메뉴">
            <a
              className="flex h-10 items-center gap-3 rounded-md bg-secondary px-3 font-medium text-secondary-foreground"
              href="#dashboard"
            >
            ...
            <a
              className="flex h-10 items-center gap-3 rounded-md px-3 text-muted-foreground transition hover:bg-muted hover:text-foreground"
              href="#reservations"
            >
        ...
        <main className="min-w-0 px-5 py-4 sm:px-7 lg:px-8">
